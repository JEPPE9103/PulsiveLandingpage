...
const steps = [
  {
    ...
    description: "Open the app and see where the city is alive right now.",
    icon: (
  ...
  },
  {
    number: "02",
    title: "Discover & talk",
    description: "See which areas and venues are alive — and what people are saying.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Become part of the city's pulse and save the moments.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
